...
export default function Hero() {
    ...
    const n = useTranslations('landing.navigation')
    const l = useTranslations('landing.hero')
        ...
        <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-white via-gray-300 to-gray-100 select-none">
            ...
            <nav className="flex items-center justify-between p-4 lg:px-8">
                <div className="flex items-center gap-8">
                    ...
                    <nav className="hidden md:flex items-center gap-3">
                        <Button variant="ghost" className="text-gray-500 hover:bg-white/5 hover:text-black">{n("trending")}</Button>
                        <Button variant="ghost" className="text-gray-500 hover:bg-white/5 hover:text-black">{n("staff_picks")}</Button>
                        <Button variant="ghost" className="text-gray-500 hover:bg-white/5 hover:text-black">{n("library")}</Button>
                        <Button variant="ghost" className="text-gray-500 hover:bg-white/5 hover:text-black">{n("for_developers")}</Button>
                        <Button variant="ghost" className="text-gray-500 hover:bg-white/5 hover:text-black">{n("portal")}</Button>
                    </nav>
                </div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 px-6 py-24 sm:py-32 text-center">
                <h1 className="text-4xl font-bold tracking-tight text-black sm:text-6xl lg:text-7xl max-w-[1024px]">
                    {l("header")}
                    <span className="text-red-500 pl-4">{l("header_color")}</span>
                </h1>
            ...
            {/* Popular Prompts */}
            <div className="py-10">
                <h2 className="text-center text-xl font-semibold text-black mb-6">{l("trending_prompts")}</h2>
